...
//     };
//     Capture capture_left1 = {
//         TIM3, TIM_Channel_1,   TIM_ICPolarity_Rising,
//         TIM_ICSelection_DirectTI, 0xF,  TIM_GetCapture1,
//     };
//     Capture capture_left2 = {
//         TIM3, TIM_Channel_2,   TIM_ICPolarity_Rising,
//         TIM_ICSelection_DirectTI, 0xF,  TIM_GetCapture2,
//     };
//     Encoder encoder_left = {
//         &gpio_encoder_left,    &tim_left,
//         &capture_left1,        &capture_left2,
...
//     };
//     Capture capture_right1 = {
//         TIM4, TIM_Channel_1,   TIM_ICPolarity_Rising,
//         TIM_ICSelection_DirectTI, 0xF,  TIM_GetCapture1,
//     };
//     Capture capture_right2 = {
//         TIM4, TIM_Channel_2,   TIM_ICPolarity_Rising,
//         TIM_ICSelection_DirectTI, 0xF,  TIM_GetCapture2,
//     };
//     Encoder encoder_right = {
//         &gpio_encoder_right,   &tim_right,
...
//                     sscanf(
//                         input, "%hd",
//                         (int16_t *)Controller_Eval(controller, "speed",
//                         DATA));
//                     info(
//                         "successfully set %s to %hd\r\n", Body,
//                         *(int16_t *)Controller_Eval(controller, "speed",
...
//                 if (strcmp(Body, "speed") == 0) {
//                     info("%s: %hd\r\n", Body,
//                          *(int16_t *)Controller_Eval(controller, Body,
//                          DATA));
//                 } else {
//                     error("unknow command\r\n");
//                 }
...
// //     Serial_SendString(serial, "\r[WATCH][Time %ds] ", RTC_time_s());
// //     Serial_SendString(serial, "pitch: %+6.1f ",
// //                       *(float *)Controller_Eval(controller, "pitch",
// DATA));
// //     Serial_SendString(
// //         serial, "speed_left: %+5hd ",
// //         *(int16_t *)Controller_Eval(controller, "speed_left", DATA));
